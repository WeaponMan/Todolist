...
<form class="form-horizontal" role="form" action="<?php echo $this->autoEscape(_PATH_ROUTE_ARGS_); ?>" method="post" id="list-member-add-form">
    <div class="form-group">    
        ...
        <div class="col-sm-3">
            <input type="text" name="name" class="form-control" id="list-member-add-name" <?php if(isset($this->vars['name'])) { ?>value="<?php echo $this->autoEscape($this->vars['name']); ?>" <?php } ?>/>
        </div>
    </div>
    <div class="form-group">
