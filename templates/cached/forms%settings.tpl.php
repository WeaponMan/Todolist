<div class="floating-form">
    <form action="<?php echo $this->autoEscape(_PATH_ROUTE_); ?>" role="form" class="form-horizontal" method="post">
        <h3>Změna hesla</h3>
...
<div class="floating-form">
    <form action="<?php echo $this->autoEscape(_PATH_ROUTE_); ?>" role="form" class="form-horizontal" method="post">
        ...
        <div class="form-group">    
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control disabled" disabled="disabled" name="email" id="email"<?php if(isset($this->vars['email'])) { ?> value="<?php echo $this->autoEscape($this->vars['email']); ?>"<?php } ?> />
            </div>
        </div>
        <div class="form-group">    
